...
func parse_label(c int) {
	...
	case '\r', '\n':
		...
		if current_instruction == FLOW_MARK {
			marks[fmt.Sprintf("%d", label)] = pc - 1
		}
		set_stage(STAGE_IMP)
		label = 1
	}
...
func dump_program() {
	for i := 0; i < pc; i++ {
		...
		case STACK_PUSH:
			instruction_type = "STACK_PUSH"
		case STACK_DUPLICATE:
			instruction_type = "STACK_DUPLICATE"
		case STACK_COPY:
			instruction_type = "STACK_COPY"
		case STACK_SWAP:
			instruction_type = "STACK_SWAP"
		case STACK_DISCARD:
			instruction_type = "STACK_DISCARD"
		case STACK_SLIDE:
			instruction_type = "STACK_SLIDE"
		case ARITHMETIC_ADD:
			instruction_type = "ARITHMETIC_ADD"
		case ARITHMETIC_SUB:
			instruction_type = "ARITHMETIC_SUB"
		case ARITHMETIC_MUL:
			instruction_type = "ARITHMETIC_MUL"
		case ARITHMETIC_DIV:
			instruction_type = "ARITHMETIC_DIV"
		case ARITHMETIC_MOD:
			instruction_type = "ARITHMETIC_MOD"
		case HEAP_STORE:
			instruction_type = "HEAP_STORE"
		case HEAP_RETRIEVE:
			instruction_type = "HEAP_RETRIEVE"
		case FLOW_MARK:
			instruction_type = "FLOW_MARK"
		case FLOW_CALL_SUB:
			instruction_type = "FLOW_CALL_SUB"
		case FLOW_JUMP:
			instruction_type = "FLOW_JUMP"
		case FLOW_JUMP_ZERO:
			instruction_type = "FLOW_JUMP_ZERO"
		case FLOW_JUMP_NEGATIVE:
			instruction_type = "FLOW_JUMP_NEGATIVE"
		case FLOW_END_SUB:
			instruction_type = "FLOW_END_SUB"
		case FLOW_END:
			instruction_type = "FLOW_END"
		case IO_OUT_CHAR:
			instruction_type = "IO_OUT_CHAR"
		case IO_OUT_NUM:
			instruction_type = "IO_OUT_NUM"
		case IO_IN_CHAR:
			instruction_type = "IO_IN_CHAR"
		case IO_IN_NUM:
			instruction_type = "IO_IN_NUM"
		}
		param := ""
		if instruction[1] == 1 {
